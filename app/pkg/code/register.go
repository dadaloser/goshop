...
func init() {
	...
	register(ErrUserAccountInactive, http.StatusForbidden, "User account is not active")
	...
	register(ErrBrandNotFound, http.StatusNotFound, "Brand not found")
	register(ErrBannerNotFound, http.StatusNotFound, "Banner not found")
	register(ErrCategoryBrandNotFound, http.StatusNotFound, "Category brand relation not found")
