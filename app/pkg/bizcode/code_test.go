...
func TestErrorCodesAreUnique(t *testing.T) {
	...
	for name, code := range map[string]int{
		...
		"app.ErrPasswordConfirmationMismatch": bizcode.ErrPasswordConfirmationMismatch,
		"app.ErrCaptchaVerificationFailed":    bizcode.ErrCaptchaVerificationFailed,
		"app.ErrDeviceSessionUnavailable":     bizcode.ErrDeviceSessionUnavailable,
