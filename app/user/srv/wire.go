...
func initApp(*options.NacosOptions, *options.ServerOptions, *options.RegistryOptions, *rpcserver.SecurityPolicy, *options.TelemetryOptions, *options.MySQLOptions) (*gapp.App, error) {
