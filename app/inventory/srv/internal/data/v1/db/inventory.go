...
func (i *inventorys) UpdateStockSellDetailStatus(ctx context.Context, txn *gorm.DB, ordersn string, status int32) error {
	...
	if status <= 0 {
		return errors.NewCode(errcode.ErrValidation, "inventory sell detail status is invalid")
	}
	...
	if result.Error != nil {
		return errorcontract.WrapDatabase(result.Error, "update inventory sell detail status")
	}
...
func (i *inventorys) GetSellDetail(ctx context.Context, txn *gorm.DB, ordersn string) (*do.StockSellDetailDO, error) {
	...
	if err != nil {
		...
		return nil, errorcontract.WrapDatabase(err, "get inventory sell detail")
	}
...
func (i *inventorys) GetSellDetailForUpdate(ctx context.Context, txn *gorm.DB, ordersn string) (*do.StockSellDetailDO, error) {
	...
	if err != nil {
		...
		return nil, errorcontract.WrapDatabase(err, "get inventory sell detail for update")
	}
	return &orderSellDetail, err
}
...
func (i *inventorys) Reduce(ctx context.Context, txn *gorm.DB, goodsID uint64, num int) error {
	...
	if num <= 0 {
		return errors.NewCode(errcode.ErrValidation, "inventory quantity is invalid")
	}
	...
	if tx.Error != nil {
		return errorcontract.WrapDatabase(tx.Error, "reduce inventory")
	}
...
func (i *inventorys) Increase(ctx context.Context, txn *gorm.DB, goodsID uint64, num int) error {
	...
	if tx.Error != nil {
		return errorcontract.WrapDatabase(tx.Error, "increase inventory")
	}
	if tx.RowsAffected == 0 {
		return errors.NewCode(bizcode.ErrInventoryNotFound, "inventory not found")
	}
...
func (i *inventorys) ConfirmSell(ctx context.Context, txn *gorm.DB, goodsID uint64, num int) error {
	...
	if tx.Error != nil {
		return errorcontract.WrapDatabase(tx.Error, "confirm inventory sale")
	}
	if tx.RowsAffected == 0 {
		return errors.NewCode(bizcode.ErrInventoryNotFound, "inventory not found")
	}
...
func (i *inventorys) CreateStockSellDetail(ctx context.Context, txn *gorm.DB, detail *do.StockSellDetailDO) error {
	...
	if tx.Error != nil {
		return errorcontract.WrapDatabase(tx.Error, "create inventory sell detail")
	}
	return nil
}
...
func (i *inventorys) CreateStockSellDetailIfAbsent(ctx context.Context, txn *gorm.DB, detail *do.StockSellDetailDO) (bool, error) {
	...
	tx := db.WithContext(ctx).
		...
		Create(detail)
	if tx.Error != nil {
		return false, errorcontract.WrapDatabase(tx.Error, "create inventory sell detail if absent")
	}
...
func (i *inventorys) Create(ctx context.Context, inv *do.InventoryDO) error {
	...
	if tx.Error != nil {
		return errorcontract.WrapDatabase(tx.Error, "create inventory")
	}
	return nil
}
...
func (i *inventorys) Adjust(ctx context.Context, inv *do.InventoryDO, audit *do.InventoryAdjustmentDO) error {
	...
	if err != nil {
		return errorcontract.WrapDatabase(err, "adjust inventory")
	}
	return nil
}
...
func (i *inventorys) ListAdjustments(ctx context.Context, goodsID uint64, offset, limit int) ([]do.InventoryAdjustmentDO, int64, error) {
	...
	if err := query.Count(&total).Error; err != nil {
		return nil, 0, errorcontract.WrapDatabase(err, "count inventory adjustments")
	}
	items := []do.InventoryAdjustmentDO{}
	if err := query.Order("id DESC").Offset(offset).Limit(limit).Find(&items).Error; err != nil {
		return nil, 0, errorcontract.WrapDatabase(err, "list inventory adjustments")
	}
...
func (i *inventorys) ListAdjustmentsByGoods(ctx context.Context, goodsIDs []uint64, limit int) ([]do.InventoryAdjustmentDO, error) {
	...
	if err := i.db.WithContext(ctx).
		...
		return nil, errorcontract.WrapDatabase(err, "list inventory adjustments by goods")
	}
	return items, nil
}
...
func (i *inventorys) Get(ctx context.Context, goodsID uint64) (*do.InventoryDO, error) {
	...
	if err != nil {
		...
		return nil, errorcontract.WrapDatabase(err, "get inventory")
	}
...
func validateStockSellDetail(detail *do.StockSellDetailDO) error {
	...
	for _, item := range detail.Detail {
		if item.Goods <= 0 || item.Num <= 0 {
			return errors.NewCode(errcode.ErrValidation, "inventory sell detail is invalid")
		}
	}
	return nil
}
