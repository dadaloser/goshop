// Package resilience provides dependency timeout, isolation, and circuit breaking.
package resilience
...
func NewOptions() *Options {
	return &Options{Enabled: true, Timeout: defaultTimeout, MaxConcurrency: defaultMaxConcurrency, ErrorRatio: defaultErrorRatio, MinRequestAmount: defaultMinRequestAmount, StatInterval: defaultStatInterval, RecoveryTimeout: defaultRecoveryTimeout}
}
...
func (o *Options) AddFlags(fs *pflag.FlagSet, prefix string) {
	...
	fs.Uint32Var(&o.MaxConcurrency, prefix+".max-concurrency", o.MaxConcurrency, "Maximum concurrent dependency operations.")
	fs.Float64Var(&o.ErrorRatio, prefix+".error-ratio", o.ErrorRatio, "Error ratio that opens the dependency circuit.")
	fs.Uint64Var(&o.MinRequestAmount, prefix+".min-request-amount", o.MinRequestAmount, "Minimum requests in the statistic window before opening the circuit.")
	fs.DurationVar(&o.StatInterval, prefix+".stat-interval", o.StatInterval, "Circuit breaker statistic window.")
	fs.DurationVar(&o.RecoveryTimeout, prefix+".recovery-timeout", o.RecoveryTimeout, "Open-circuit duration before a half-open recovery probe.")
}
